...
def main():
    ...
    parser.add_argument('--basic_edit', type=str, required=True, help='Path to the JSON file containing the basic edit information')
    ...
    with open(args.basic_edit, 'r', encoding='utf-8') as f:
